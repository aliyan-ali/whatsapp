...
function Signup() {
  return (
    <Box className="signin-bg" sx={{ padding: "35px 0px", height: "100vh" }}>
      <Box sx={{display:'flex', justifyContent:'start', alignItems:'center', gap:'10px', padding:'0px 0px 35px 25vw', cursor:'default'}}>
        <svg
        ...
        <Typography sx={{fontSize:"14px",color:'white',fontWeight:'600', letterSpacing:'1px'}}>WHATSAPP WEB</Typography>
      </Box>
      <Box sx={{ height: "90%" }}>
        <Container
